...
public class TestCarsService {
	...
	public boolean testAddCar(ICarsManagement cars, String model, String brand) throws RemoteException {
		...
		for(ICar c : cars.getCars())
			System.out.println("\n Car id : "+c.getId()+" Model : "+ c.getModel()+" Brand : "+c.getBrand());
	...
	public boolean testRemoveCar(ICarsManagement cars, int id) {
	...
	public boolean testSearchCarByModel(ICarsManagement cars, String model) {
	...
	public boolean testSearchCarByBrand(ICarsManagement cars, String brand) {
	...
	public boolean testSearchCarById(ICarsManagement cars, int id) {
		...
		boolean result = false;
			...
			try {
				...
				//Display the returned value 
				System.out.println("\n Car id : "+result_car.getId()+" Model : "+ result_car.getModel()+" Brand : "+result_car.getBrand());
	...
	public boolean testSetCar(ICarsManagement cars, String model, String changeTo, boolean availability) {
			...
			try {
				...
				for(ICar c : cars.getCars()) {
					...
					System.out.println("\n Car id : "+c.getId()+" Model : "+ c.getModel()+" Brand : "+c.getBrand()+" Availability : "+availability);

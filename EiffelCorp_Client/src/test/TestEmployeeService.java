...
public class TestEmployeeService {
	...
	public boolean testRemoveEmployee(IEmployManagement employees, int id) {
	...
	public boolean testSearchEmployeesByFirstName(IEmployManagement employees, String firstName) {
	...
	public boolean testSearchEmployeeById(IEmployManagement employees, int id) {
		...
		boolean result = false;
			...
			try {
				...
				//Display the returned value 
				System.out.println("\n Employee id : "+result_employee.getId()+" FirstName : "+ result_employee.getFirstName() +" LastName : "+result_employee.getLastName()+" Email : "+ result_employee.getEmail()+" Address : "+result_employee.getAddress()+" Age : "+result_employee.getAge() );
	...
	public boolean testSetEmployee(IEmployManagement employees, String firstName, String changeTo) {
	...
	public static void main(String[] args) throws RemoteException, MalformedURLException  {
		...
		try {
			...
			IEmployManagement employees = (IEmployManagement) Naming.lookup("rmi://localhost:1100/EmployeeManagement");

...
public class TestFeedBackService {
		...
		public boolean testRemoveFeedBack(IFeedBackManagement feedBacks, int id) {
		...
		public boolean testSearchFeedBacksByCarId(IFeedBackManagement feedBacks, int car_id) {
		...
		public boolean testSearchFeedBackByEmployeeId(IFeedBackManagement feedBacks, int employee_id) {
		...
		public boolean testSearchFeedBackById(IFeedBackManagement feedBacks, int id) {
			...
			boolean result = false;
				...
				try {
					...
					//Display the returned value 
					System.out.println("\n FeedBack id : "+result_feedBack.getId()+" Car id : "+ result_feedBack.getCar_id()+" Employee Id : "+result_feedBack.getEmployee_id()+" Rating : "+result_feedBack.getRating()+" Description : "+result_feedBack.getDescription());
		...
		public boolean testSetFeedBack(IFeedBackManagement feedBacks, int car_id, int changeTo) {
